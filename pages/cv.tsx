					...
					<section>
						...
						<div className="ml-2 mt-4">
							...
							<div className="relative">
								...
								<div className="absolute -left-3 top-3 h-6 w-6 bg-gray-300 rounded-full ring-2 ring-gray-100"></div>
								<article className="ml-8 pb-8">
									<h3 className="font-semibold">Founder</h3>
									<h4 className="text-gray-500 text-sm">Gearstone Technology</h4>
									<div className="prose mt-2">
										<div className="prose">
											Started a company specialising in developing web-based products:
                  <ul>
